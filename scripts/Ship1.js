class Ship1{
    ...
    constructor(position_x, position_y, angle){
        ...
        this.sprite_ship = loadImage("data/sprites/Ships/ship1.png");
        this.angle = angle;
        this.speed = 0;
        this.speed_x = 0;
        this.speed_y = 0;
    ...
    fire(){
            ...
            ship1_cannonballs.push(firing_cannonball);
    }   
    
    collide(){

        //Geminin Toplarla Çarpışması
        for (let i = 0; i < ship2_cannonballs.length; i++) {
            if(collide_circle_circle(this.position_x, this.position_y, 75/2, ship2_cannonballs[i].position_x, ship2_cannonballs[i].position_y, 5)){
        ...
        //Geminin Diğer Gemiyle Çarpışması
        if(collide_circle_circle(this.position_x, this.position_y, this.sprite_ship.width/2, ship2.position_x, ship2.position_y, ship2.sprite_ship.width/2)){
            print("Diğer Gemiyle Çarpıştı.");
        }
    ...
    detect_fire_direction(){
        ...
        //let px = mouseX;
        //let py = mouseY;
        let px = ship2.position_x;
        let py = ship2.position_y;
